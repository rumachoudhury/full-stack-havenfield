      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="max-w-sm text-sm leading-relaxed">
            A curated real estate studio finding thoughtfully designed homes for
            people who care where they live.
          </p>
        </div>

        <div>
          <h4 className="text-cream text-sm tracking-wide uppercase mb-4">
            Explore
          </h4>
        ...
        <div>
          ...
          <div className="flex gap-4">
            ...
            >
              <Instagram
                className="w-5 h-5 hover:text-clay transition-colors cursor-pointer"
                strokeWidth={1.5}
              />
            </a>
